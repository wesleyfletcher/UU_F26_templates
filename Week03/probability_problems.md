...
- a. Write out the simplest (with respect to events) probablility space that models this gamble. If you had to write all the possible events, what would the answer look like?
